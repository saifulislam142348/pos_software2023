            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box">
                    <a href="index.html" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="{{ asset('admin/assets/images/logo.svg" alt="" he') }}ght="22">
                                </span>
                        <span class="logo-lg">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="row">
                                    ...
                                    <div class="col-sm-5">
                                        <div>
                                            <img src="{{ asset('admin/assets/images/megamenu-img.png" a') }}t=""
            ...
            <div class="d-flex">
                ...
                <div class="dropdown d-inline-block">
                    <button type="button" class="btn header-item waves-effect"
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img id="header-lang-img" src="{{ asset('admin/assets/images/flags/us.jpg" alt="') }}eader Language" height="16">
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">

                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="en">
                            <img src="{{ asset('admin/assets/images/flags/us.jpg" alt="') }}ser-image" class="me-1" height="12"> <span
                                class="align-middle">English</span>
                        </a>
                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="sp">
                            <img src="{{ asset('admin/assets/images/flags/spain.jpg" al') }}="user-image" class="me-1" height="12"> <span
                                class="align-middle">Spanish</span>
                        </a>

                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="gr">
                            <img src="{{ asset('admin/assets/images/flags/germany.jpg" ') }}lt="user-image" class="me-1" height="12"> <span
                                class="align-middle">German</span>
                        </a>

                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="it">
                            <img src="{{ asset('admin/assets/images/flags/italy.jpg" al') }}="user-image" class="me-1" height="12"> <span
                                class="align-middle">Italian</span>
                        </a>

                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="ru">
                            <img src="{{ asset('admin/assets/images/flags/russia.jpg" a') }}t="user-image" class="me-1" height="12"> <span
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                        <div class="px-lg-2">
                            <div class="row g-0">
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#">
                                        <img src="{{ asset('admin/assets/images/brands/github.png" ') }}lt="Github">
                                        <span>GitHub</span>
                                    </a>
                                </div>
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#">
                                        <img src="{{ asset('admin/assets/images/brands/bitbucket.pn') }}" alt="bitbucket">
                                        <span>Bitbucket</span>
                                    </a>
                                </div>
                                <div class="col">
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#">
                                        <img src="{{ asset('admin/assets/images/brands/mail_chimp.p') }}g" alt="mail_chimp">
                                        <span>Mail Chimp</span>
                                    </a>
                                </div>
                                <div class="col">
                                    <a class="dropdown-icon-item" href="#">
                                        <img src="{{ asset('admin/assets/images/brands/slack.png" a') }}t="slack">
                                        <span>Slack</span>
                                    </a>
                                </div>
                            </div>
                    ...
                    <li>
                        ...
                        <ul class="sub-menu" aria-expanded="false">
                            ...
                            <li><a href="dashboard-job.html"><span class="badge rounded-pill text-bg-success float-end"
                                                                   key="t-new">New</span> <span key="t-jobs">Jobs</span></a>
                            </li>
                        </ul>
                    </li>
                            ...
                            <div class="bg-primary bg-soft">
                                <div class="row">
                                    ...
                                    <div class="col-5 align-self-end">
                                        <img src="{{ asset('admin/assets/images/profile-img.png" al') }}="" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="table-responsive">
                            <table class="table align-middle table-nowrap">
                                ...
                                <tr>
                                    <th scope="row">
                                        <div>
                                            <img src="{{ asset('admin/assets/images/product/img-7.png" ') }}lt="" class="avatar-sm">
                                        </div>
                                    </th>
                                    <td>
                                        <div>
                                ...
                                <tr>
                                    <th scope="row">
                                        <div>
                                            <img src="{{ asset('admin/assets/images/product/img-4.png" ') }}lt="" class="avatar-sm">
                                        </div>
                                    </th>
                                    <td>
                                        <div>
...
<div class="right-bar">
    <div data-simplebar class="h-100">
        ...
        <div class="p-4">
            <div class="mb-2">
                <img src="{{ asset('admin/assets/images/layouts/layout-1.jp') }}" class="img-thumbnail" alt="layout images">
            </div>
            ...
            <div class="mb-2">
                <img src="{{ asset('admin/assets/images/layouts/layout-2.jp') }}" class="img-thumbnail" alt="layout images">
            </div>
            <div class="form-check form-switch mb-3">
            ...
            <div class="mb-2">
                <img src="{{ asset('admin/assets/images/layouts/layout-3.jp') }}" class="img-thumbnail" alt="layout images">
            </div>
            <div class="form-check form-switch mb-3">
            ...
            <div class="mb-2">
                <img src="{{ asset('admin/assets/images/layouts/layout-4.jp') }}" class="img-thumbnail" alt="layout images">
            </div>
